        ...
        <div className={cn(
          ...
          <div className="bg-white p-8 rounded-lg shadow-lg mx-auto">
            ...
            <p className="text-gray-700 text-lg">
              ...
              buscando sempre os melhores resultados para nossos clientes.
            </p>
          </div>
        </div>
            ...
            <div className="flex flex-col md:flex-row items-center">
              <div className="w-48 h-48 rounded-full overflow-hidden mb-6 md:mb-0 md:mr-8 border-4 border-accent flex-shrink-0">
                <Avatar className="w-full h-full">
                  ...
                  <AvatarFallback className="bg-primary text-white text-3xl">EA</AvatarFallback>
                </Avatar>
              </div>
              <div>
                <h4 className="text-2xl font-semibold text-primary mb-3 text-center md:text-left">Eduardo Arrivabene</h4>
                <p className="text-accent text-lg mb-4 text-center md:text-left font-medium">OAB/SP nº 375.994</p>
          ...
          <div className="grid md:grid-cols-3 gap-8 mt-8">
            ...
            <Card className="shadow-lg hover:shadow-xl transition-shadow border-t-4 border-t-accent">
              <CardHeader className="pb-2">
                ...
                <CardTitle className="text-center text-primary text-2xl">Missão</CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card className="shadow-lg hover:shadow-xl transition-shadow border-t-4 border-t-accent">
              <CardHeader className="pb-2">
                ...
                <CardTitle className="text-center text-primary text-2xl">Visão</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-700 text-center text-lg">
            ...
            <Card className="shadow-lg hover:shadow-xl transition-shadow border-t-4 border-t-accent">
              <CardHeader className="pb-2">
                ...
                <CardTitle className="text-center text-primary text-2xl">Valores</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-700 text-center text-lg">
